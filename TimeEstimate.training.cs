...
{
    public partial class TimeEstimate
    {
        public const string RetrainFilePath =  @"C:\Users\horat\Downloads\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=978,MinimumExampleCountPerLeaf=20,LearningRate=0.4505733360725695,LabelColumnName=@"trip_time_in_secs",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9617439178997776,L1Regularization=2.497174326291078E-10,L2Regularization=0.8077510576517684},MaximumBinCountPerFeature=228}));
